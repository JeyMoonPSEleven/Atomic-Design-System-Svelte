...
{#snippet logo()}
	<a href="/" class="text-xl font-bold text-text-default"
		>Atomic Design Showcase</a
	>
{/snippet}

{#snippet navigation()}
	<nav class="flex gap-4">
		<a href="/" class="text-text-default hover:text-primary">Inicio</a>
		<a href="/showcase" class="text-primary font-semibold">Showcase</a>
	</nav>
{/snippet}
...
{#snippet mobileNavigationPanel()}
	<div class="p-4 space-y-2">
		<a href="/" class="block text-text-default hover:text-primary">Inicio</a
		>
		<a href="/showcase" class="block text-primary font-semibold">Showcase</a
		>
	</div>
{/snippet}
