<script lang="ts">
	...
	import { Breadcrumb, Text } from '$lib/components/02-molecules';
	import { Text as TextAtom } from '$lib/components/01-atoms';
	...
	const variants = [
		...
		},
		{
			title: 'With Binding',
			component: () => {},
			code: '<Checkbox bind:checked={value} />'
		}
	];
	...
	const props = [
		...
		},
		{
			...
			default: 'false',
			required: false,
			description: 'Estado del checkbox (bindable)'
		},
		{
			name: 'class',
			type: 'string',
